// $ANTLR 3.5.2 /home/user/cassandra-trunk/src/antlr/Cql.g 2019-12-04 20:31:55
...
public class CqlParser extends Parser {
	...
	@Override public String getGrammarFileName() { return "/home/user/cassandra-trunk/src/antlr/Cql.g"; }
	...
	// $ANTLR start "query"
	// /home/user/cassandra-trunk/src/antlr/Cql.g:132:1: query returns [CQLStatement.Raw stmnt] : st= cqlStatement ( ';' )* EOF ;
	public final CQLStatement.Raw query() throws RecognitionException {
		...
		try {
			// /home/user/cassandra-trunk/src/antlr/Cql.g:133:5: (st= cqlStatement ( ';' )* EOF )
			// /home/user/cassandra-trunk/src/antlr/Cql.g:133:7: st= cqlStatement ( ';' )* EOF
			{
			pushFollow(FOLLOW_cqlStatement_in_query77);
			st=cqlStatement();
			state._fsp--;

			// /home/user/cassandra-trunk/src/antlr/Cql.g:133:23: ( ';' )*
			loop1:
			while (true) {
				int alt1=2;
				...
				switch (alt1) {
				case 1 :
					// /home/user/cassandra-trunk/src/antlr/Cql.g:133:24: ';'
					{
